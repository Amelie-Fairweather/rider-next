    ...
    <>
      ...
      <div className="container">
        ...
        <div className="middle" style={{ 
          ...
          <p style={{ marginBottom: '24px' }}>
            Many kids who only have one parent, really busy schedules, or only one car, had to miss practices or other after school activities. Ride solves this problem. Rather than forcing parents to find a break in their schedule, or paying for Ubers, Ride allows parents to organize carpools or find other people driving in the area.
          </p>
          <p style={{ marginBottom: '24px' }}>Use Ride to get you where you need to go</p>
        </div>
        <div style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center", marginTop: 40 }}>
          <div className="buttons" style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
      ...
      <div style={{ 
        ...
        For any issues, please contact me at ameliefairweather0@Gmail.com
      </div>
    </>
  );
}
